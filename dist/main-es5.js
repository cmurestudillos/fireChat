...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"main-container\">\n  <div class=\"row\">\n    <div class=\"col col-lg-2 mr-1\" *ngIf=\"_chats.usuario.id\">\n      <h1>Firechat</h1>\n    </div>\n    <div class=\"col mt-2\" *ngIf=\"_chats.usuario.id\">\n      <button class=\"btn btn-outline-danger w-25\" (click)=\"_chats.logout()\"> Salir </button>\n    </div>\n  </div>\n\n  <app-login *ngIf=\"!_chats.usuario.id\"></app-login>\n  <diV class=\"chat-window\" *ngIf=\"_chats.usuario.id\">\n    <app-chat></app-chat>\n  </diV>\n</div>\n";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsChatChatComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<h1> Chat </h1>\n<hr>\n\n<div class=\"app-mensajes\" id=\"app-mensajes\">\n  <div *ngFor=\"let chat of _chat.chats\" [ngClass]=\"{'text-right': _chat.usuario.id == chat.id}\">\n    <span class=\"badge\" [ngClass]=\"{'badge-primary': _chat.usuario.id == chat.id, 'badge-success': _chat.usuario.id != chat.id}\"> {{chat.nombre}} </span>\n    <p> {{ chat.mensaje}} </p>\n  </div>\n</div>\n<hr>\n<input class=\"form-control\" type=\"text\" name=\"mensaje\" [(ngModel)]=\"mensaje\" (keyup.enter)=\"enviarMensaje()\" placeholder=\"Enviar mensaje...\">\n";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsLoginLoginComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"row\">\n  <div class=\"col-md-12 text-center\">\n    <p>Ingrese al chat con su cuenta:</p>\n    <button type=\"button\" class=\"btn btn-outline-primary w-25\" (click)=\"ingresar('google')\"> Google </button>\n    <button type=\"button\" class=\"btn btn-outline-info w-25\"(click)=\"ingresar('github')\"> GitHub </button>\n  </div>\n</div>\n";
    /***/
  },
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = function AppComponent(_chats) {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./services/chat.service */
    "./src/app/services/chat.service.ts"); // Importa componentes
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _components_chat_chat_component__WEBPACK_IMPORTED_MODULE_9__["ChatComponent"], _components_login_login_component__WEBPACK_IMPORTED_MODULE_10__["LoginComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_5__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].firebase), _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_6__["AngularFirestoreModule"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_7__["AngularFireAuthModule"]],
  ...
  function srcAppComponentsChatChatComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/services/chat.service.ts"); // Importamos el servicio


    var ChatComponent =
    /*#__PURE__*/
    function () {
      function ChatComponent(_chat) {
        var _this = this;
        ...
        this._chat.cargarMensajes().subscribe(function () {
          setTimeout(function () {
      ...
      _createClass(ChatComponent, [{
        ...
        value: function enviarMensaje() {
          ...
          if (this.mensaje.length === 0) {
            ...
            this._chat.agregarMensaje(this.mensaje).then(function () {
              _this2.mensaje = "";
  ...
  function srcAppServicesChatServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function ChatService(afs, afAuth) {
        ...
        this.afAuth.authState.subscribe(function (user) {
          ...
          if (!user) {
            ...
            _this3.usuario.nombre = user.displayName;
            _this3.usuario.id = user.uid;
          }
        });
      }
      ...
      _createClass(ChatService, [{
        key: "login",
        value: function login(proveedor) {
          if (proveedor === 'google') {
            this.afAuth.auth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_5__["auth"].GoogleAuthProvider());
          } else {
            this.afAuth.auth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_5__["auth"].GithubAuthProvider());
          }
        }
      }, {
        key: "logout",
        ...
        value: function cargarMensajes() {
          ...
          return this.itemsCollection.valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (mensajes) {
            console.log(mensajes); // Inicializamos el Array
            ...
            try {
              for (var _iterator = mensajes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var mensaje = _step.value;

                _this4.chats.unshift(mensaje);
              }
            } catch (err) {
            ...
            return _this4.chats; // this.chats = mensajes;
          }));
  ...
  function srcEnvironmentsEnvironmentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var environment = {
      production: false,
      firebase: {
        apiKey: 'AIzaSyAsYALYeV8YbbRgskjpZ_Z4jQUxIQl0hQY',
        authDomain: 'firechat-995f9.firebaseapp.com',
        databaseURL: 'https://firechat-995f9.firebaseio.com',
        projectId: 'firechat-995f9',
        storageBucket: 'firechat-995f9.appspot.com',
        messagingSenderId: '28578029064'
      }
    };
    /*
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\cme022es\Documents\Carlos Mur\visual-code\curso_angular\Angular\10-fireChat\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
